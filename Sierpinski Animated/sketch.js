...
function draw() {
  background(220);
  noFill();
  await drawTriangle(p1, p2, p3);
  // noLoop();
}
async function drawTriangle(p_1, p_2, p_3) {
  setTimeout(() => {}, 2000);
  ...
  await drawTriangle(p_1, new_p1, new_p3);
  await drawTriangle(new_p1, p_2, new_p2);
  await drawTriangle(new_p3, new_p2, p_3);
